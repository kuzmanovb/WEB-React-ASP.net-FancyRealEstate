...
export const Privacy = () => {
    return (
        <div className="container pt-5">
            <h1 className="text-center font-weight-bold">Privacy Policy of <span>Fancy Real Estate</span></h1>

            <p>At <span class="website_name">Fancy Real Estate</span>, we collect and manage user data according to the following Privacy Policy.</p>

            <h3 className="text-center pt-3">Data Collected</h3>
            ...
            <p>We also use various technologies to collect information, and this may include sending cookies to your computer. Cookies are small data files stored on your hard drive or in your device memory that helps us to improve our services and your experience, see which areas and features of our services are popular and count visits. We may also collect information using web beacons (also known as "tracking pixels"). Web beacons are electronic images that may be used in our services or emails and to track count visits or understand usage and campaign effectiveness. Our Privacy Policy was created with the help of the <a href="https://www.privacy-policy-template.com" target="_blank">Privacy Policy Template</a> and the <a href="https://www.generateprivacypolicy.com" target="_blank">Generate Privacy Policy Generator</a>.</p>

            <h3 className="text-center pt-3">Use of the Data</h3>

            <p>We only use your personal information to provide you the <span class="website_name">Fancy Real Estate</span> services or to communicate with you about the Website or the services.</p>
            ...
            <h3 className="text-center pt-3">Sharing of Data</h3>
            ...
            <h3 className="text-center pt-3">Cookies</h3>

            <p>We may use cookies on our site to remember your preferences.</p>

            <p>For more general information on cookies, please read <a href="https://www.privacypolicyonline.com/what-are-cookies/" target="_blank">"What Are Cookies"</a>.</p>

            <h3 className="text-center pt-3">Opt-Out, Communication Preferences</h3>
            ...
            <h3 className="text-center pt-3">Security</h3>
            ...
            <h3 className="text-center pt-3">About Children</h3>
            ...
            <h3 className="text-center pt-3">Changes to the Privacy Policy</h3>
