...
const validationSchema = Yup.object().shape({
    ...
    size: Yup.string().min(2).max(5).required("Please input size"),
    floor: Yup.string().min(1).max(2).required("Please input floor"),
    totalNumberOfFloor: Yup.string().min(1).max(2).required("Please input of total floors"),
